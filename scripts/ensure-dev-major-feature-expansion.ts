...
const STORES = [
  { name: 'ê°•ë‚¨ ?¤í¬ë¦??¼ìš´ì§€', sido: '?œìš¸?¹ë³„??, sigungu: 'ê°•ë‚¨êµ?, brand: 'GOLFZON' as const, blurb: '?¼ê°„ ?¼ìš´??ë§›ì§‘' },
  { name: 'ë¶„ë‹¹ ì¹´ì¹´?¤VX ?¤íŠœ?”ì˜¤', sido: 'ê²½ê¸°??, sigungu: '?±ë‚¨??, brand: 'KAKAO_VX' as const, blurb: 'ì¡°ìš©???°ìŠµ ê³µê°„' },
  { name: '?˜ì› SG ?Œí¬', sido: 'ê²½ê¸°??, sigungu: '?˜ì›??, brand: 'SG_GOLF' as const, blurb: 'ê°€ì¡??¼ìš´??ì¶”ì²œ' },
  { name: 'ë§ˆí¬ ë¯¸ë“œ?˜ì‡ ?¤í¬ë¦?, sido: '?œìš¸?¹ë³„??, sigungu: 'ë§ˆí¬êµ?, brand: 'OTHER' as const, other: '?ì²´ ?œë??ˆì´??, blurb: '?¬ì•¼ ?¤í”ˆ' },
  { name: '?¡íŒŒ ê³¨í”„ì¡??´ëŸ½', sido: '?œìš¸?¹ë³„??, sigungu: '?¡íŒŒêµ?, brand: 'GOLFZON' as const, blurb: 'ì£¼ì°¨Â·?¤ì›Œ ?„ë¹„' },
];

const BANNERS = [
  { title: '?¤ëŠ˜ ë§ëŠ” ì¡°ì¸ ì°¾ê¸°', subtitle: '?˜ì? ??ë§ëŠ” ?¼ìš´??, href: '/(tabs)/joins', sortOrder: 1 },
  { title: '?¤í¬ë¦?ë§¤ì¥ ?˜ëŸ¬ë³´ê¸°', subtitle: 'ê²€ì¦ëœ ë§¤ì¥?ì„œ ì¡°ì¸ ë§Œë“¤ê¸?, href: '/stores', sortOrder: 2 },
  { title: 'ì¶œì„?˜ê³  ì½”ì¸ ë°›ê¸°', subtitle: '?˜ë£¨ ??ë²?ì¶œì„ ë³´ìƒ', href: '/my/rewards', sortOrder: 3 },
];
