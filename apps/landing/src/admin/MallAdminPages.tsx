  ...
  return (
    <div className="stack">
      <div className="row between">
        <h2>쪼인몰 관리</h2>
        <button type="button" onClick={() => navigate('/admin/mall/products/new')}>상품 등록</button>
      </div>
        ...
        {items.map((item) => (
          <div key={item.id} className="card mall-admin-card">
            ...
            <div className="stack tight">
              ...
              <span className="status-badge status-badge--info">{item.status}</span>
...
export function MallAdminEditPage() {
  ...
  return (
    <div className="stack">
      <button type="button" onClick={() => navigate('/admin/mall/products')}>← 상품 목록</button>
